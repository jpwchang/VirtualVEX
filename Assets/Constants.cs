...
public class Constants {
    public static readonly string abtText = "VirtualVEX v. 2.0.0 (Beta)\nOpen source VEX robotics competition simulator"
    ...
    public static readonly string VERSION = "2.0 Beta";
#else
    public static readonly string VERSION = "2.0 Beta (Linux)";
#endif
}
