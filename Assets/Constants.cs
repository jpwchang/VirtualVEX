...
public class Constants {
    public static readonly string abtText = "VirtualVEX v. 2.0.0a2\nOpen source VEX robotics competition simulator"
    ...
    public static readonly string VERSION = "2.0 Alpha 2";
#else
    public static readonly string VERSION = "2.0 PREREL_LIN";
#endif
}
